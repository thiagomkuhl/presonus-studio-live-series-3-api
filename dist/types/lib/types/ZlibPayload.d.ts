...
export interface Filtergroup {
    children: {
        [key: string]: AutofiltergroupChild;
    };
}
...
export declare enum CompClassID {
...
export declare enum PurpleUnits {
...
export declare enum PreampgainUnits {
    Gain0 = "gain.0"
}
